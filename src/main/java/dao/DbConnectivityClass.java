...
public class DbConnectivityClass {
    final static String DB_NAME="csc311mosesserver";
        MyLogger lg= new MyLogger();
        final static String SQL_SERVER_URL = "jdbc:mysql://csc311mosesserver.mysql.database.azure.com";//update this server name
        final static String DB_URL = "jdbc:mysql://csc311mosesserver.mysql.database.azure.com/"+DB_NAME;//update this database name
        final static String USERNAME = "miltonmoses";// update this username
        final static String PASSWORD = "norzy5-myttuP-pehgab";// update this password
